...
exports.VisualMaestraPlatform = void 0;
const events_1 = require("events");
const WorkflowOrchestrator_js_1 = require("../orchestration/WorkflowOrchestrator.js");
const StreamingManager_js_1 = require("../streaming/StreamingManager.js");
const ADWQualityGates_js_1 = require("../validation/ADWQualityGates.js");
const EvidenceDashboard_js_1 = require("../monitoring/EvidenceDashboard.js");
/**
 * Main Platform Integration Class
 * Orchestrates the complete 6-component autonomous development platform
 */
class VisualMaestraPlatform extends events_1.EventEmitter {
    config;
    orchestrator;
    streamingManager;
    qualityGates;
    ...
    constructor(config) {
        ...
        this.orchestrator = new WorkflowOrchestrator_js_1.VisualMaestraOrchestrator(config);
        this.streamingManager = new StreamingManager_js_1.StreamingManager(config);
        this.qualityGates = new ADWQualityGates_js_1.ADWQualityGates();
        this.evidenceDashboard = new EvidenceDashboard_js_1.EvidenceDashboard();
     ...
     */
    async initializeQualitySystems() {
        // Setup quality gate coordination
        this.qualityGates.on('gate_executed', (execution) => {
            this.evidenceDashboard.updateQualityGateStatus(execution.workflowId, execution);
        });
     ...
     */
    async executeCardWorkflow(cardContext) {
        try {
            ...
            if (result.evidence) {
                this.evidenceDashboard.updateWorkflowEvidence(result.workflowId, result.currentPhase, 'platform', result.evidence);
            }
     ...
     */
    async executeQualityGates(result) {
        ...
        try {
            ...
            const gateExecutions = await this.qualityGates.executeAllGates(result.workflowId, result.evidence, validationData);
     ...
     */
    async triggerInvestigation(data) {
        try {
     ...
     */
    async enableFlashAttentionOptimizations() {
...
exports.VisualMaestraPlatform = VisualMaestraPlatform;
//# sourceMappingURL=VisualMaestraMain.js.map